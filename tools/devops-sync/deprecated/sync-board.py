...
# -*- coding: utf-8 -*-
"""
Sincronizacao Board: STATUS.yaml -> Azure DevOps Columns
Conforme CONTRATO DE DEVOPS - GOVERNANCA

Este script sincroniza os RFs com base nas regras de coluna do Board:
...
PRINCIPIO:
- Automacao so pode mover ate Testes QA
- Estados Resolved e Closed sao exclusivos do usuario
"""
