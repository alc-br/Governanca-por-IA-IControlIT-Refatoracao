...
3. **Relevant RF documentation** in docs/XX-Requisitos-Funcionais/RFXXX-[nome]/
...
2. **Locate RF documentation** in docs/XX-Requisitos-Funcionais/
3. **Extract requirements**: Use Cases, business rules, validations
4. **Create implementation plan**: Save to .tempdocs/PROMPT-IMPLEMENTACAO-RF-XXX.md
...
1. **Use Cases (UC)** - Only if not existing: docs/XX-Requisitos-Funcionais/RFXXX-[nome]/Casos de Uso/UC0X-[nome].md
2. **Data Models (MD)** - Only if not existing: docs/XX-Requisitos-Funcionais/RFXXX-[nome]/Modelo de Dados/MD0X-[nome].md
...
Follow templates in docs/99-Templates/
...
- Create .tempdocs/RF-XXX-RELATORIO-FINAL-100-PRODUCAO.md
...
- ✅ **Known errors from ERROS-A-EVITAR.md** - Apply documented solution
...
AI: "RF-010 implementado 100%. Backend e Frontend compilando e rodando.
     Relatório: .tempdocs/RF-010-RELATORIO-FINAL-100-PRODUCAO.md"
```
...
Relatório completo: .tempdocs/RF-XXX-RELATORIO-FINAL-100-PRODUCAO.md
```
