...
```
 D:\IC2\documentacao\Fase-5-Service-Desk\EPIC008-SD-Service-Desk\RF028-Gestao-de-SLA-Operacoes\
...
```bash
git add docs/documentacao/**/RF028.md
git add docs/documentacao/**/RF028.yaml
git add docs/documentacao/**/RL-RF028.md
git add docs/documentacao/**/RL-RF028.yaml
git add docs/documentacao/**/STATUS.yaml
git add docs/documentacao/**/RELATORIO-MIGRACAO-V2.0.md
