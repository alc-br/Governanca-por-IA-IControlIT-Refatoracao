...
governanca:
  ...
  separacao_rf_rl:           # ← ADICIONADO
    documentacao_md_criado: true
    documentacao_yaml_criado: true
    rl_md_criado: true
    rl_yaml_criado: true
...
```
 D:\IC2\documentacao\Fase-3-Financeiro-I-Base-Contabil\EPIC006-FIN-Financeiro-Base\RF026-Gestao-de-Faturas\
