...
**Descrição**: Se informado, o CNPJ deve ser único dentro do tenant (Fornecedor).
...
- Mensagem: "CNPJ já cadastrado neste Fornecedor"
...
**Descrição**: Todas as consultas devem filtrar por tenant_id (Fornecedor) do usuário autenticado.
...
- **RF-006** - Gestão de Clientes (para definir Fornecedor/tenant)
