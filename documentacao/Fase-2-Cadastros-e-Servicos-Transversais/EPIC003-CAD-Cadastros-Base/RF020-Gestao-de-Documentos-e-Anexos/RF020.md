...
- [x] Multi-tenancy por Fornecedor
...
### RN-RF020-015 — Multi-Tenancy por Fornecedor

**Descrição**: Todos os documentos DEVEM estar isolados por Fornecedor (multi-tenancy).

**Justificativa**: Segurança e isolamento de dados entre diferentes clientes.

**Critério de Aceite**:
- Constraint obrigatória: `Id_Fornecedor` em todas as tabelas
- Queries filtram automaticamente por Fornecedor do usuário logado
- Usuários não podem acessar documentos de outros Fornecedores
- Compartilhamento externo (via link) respeita isolamento de Fornecedor
...
- Nenhuma operação pode violar isolamento de Fornecedor (multi-tenancy)
