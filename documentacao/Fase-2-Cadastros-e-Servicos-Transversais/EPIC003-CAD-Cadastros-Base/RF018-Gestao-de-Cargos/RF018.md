...
### RN-RF018-001 — Código de Cargo Único por Fornecedor

**Descrição**: O código do cargo deve ser único dentro do Fornecedor (multi-tenancy). Permite mesmo código em Fornecedores diferentes.
