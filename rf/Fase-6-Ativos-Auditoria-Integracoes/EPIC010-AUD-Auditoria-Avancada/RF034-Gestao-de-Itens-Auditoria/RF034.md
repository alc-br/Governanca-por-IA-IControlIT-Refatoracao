...
**Descrição**: Todos os itens de auditoria devem estar obrigatoriamente isolados por FornecedorId (ClienteId). Global Query Filters garantem isolamento automático em todas as queries.
...
- Global Query Filter aplica WHERE FornecedorId = CurrentClientId automaticamente
...
- Índices criados em AuditoriaResumoId, BilheteId, Lote, FornecedorId
