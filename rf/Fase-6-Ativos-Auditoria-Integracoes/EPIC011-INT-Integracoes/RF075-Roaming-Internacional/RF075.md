...
### RN-RF075-11 — Multi-Tenancy: Isolamento por Fornecedor

**Descrição**: Todas as solicitações, limites e consumos são isolados por Fornecedor (tenant). Usuário só pode acessar dados do seu Fornecedor.
