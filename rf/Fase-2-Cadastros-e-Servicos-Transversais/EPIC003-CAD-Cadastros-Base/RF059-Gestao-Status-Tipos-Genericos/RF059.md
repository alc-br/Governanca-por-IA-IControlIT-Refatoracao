...
- [x] Multi-tenancy rigoroso (isolamento por ClienteId e FornecedorId)
...
| **Global vs. Customizado** | Itens globais são fornecidos pelo sistema e aplicam-se a todos os clientes. Itens customizados são criados por clientes específicos e visíveis apenas dentro do seu tenant (ClienteId/FornecedorId). |
