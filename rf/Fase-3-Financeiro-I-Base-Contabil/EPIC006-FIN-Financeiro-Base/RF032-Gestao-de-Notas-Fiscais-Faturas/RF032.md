...
**Critério de Aceite**:
- Container segregado por conglomerado: `notas-fiscais-{conglomeradoId}`
...
**Multi-tenancy**: ConglomeradoId obrigatório em todas tabelas
...
| **Row-Level Security** | Filtro automático por ConglomeradoId |
...
- [ ] Validação de permissões (acesso cruzado entre conglomerados)
