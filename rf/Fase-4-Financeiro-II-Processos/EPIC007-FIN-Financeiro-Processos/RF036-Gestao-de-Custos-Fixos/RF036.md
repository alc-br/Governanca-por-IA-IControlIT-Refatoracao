...
- [x] Multi-tenancy com isolamento por conglomerado
...
**Descrição**: Todos os custos fixos e lançamentos devem estar isolados por ConglomeradoId. Um usuário só pode acessar dados do seu próprio conglomerado.
...
- Queries automáticas filtram por ConglomeradoId do usuário autenticado
...
|--------|---------------|-----------------|
| CustoFixoCriado | Após criação bem-sucedida | Id, Descricao, ValorOrcado, ConglomeradoId |
...
- Todas as queries devem filtrar automaticamente por ConglomeradoId do usuário autenticado
- Tentativas de acesso cruzado devem retornar HTTP 404 (não 403, para não revelar existência)
- ConglomeradoId deve ser obrigatório em todas as entidades
