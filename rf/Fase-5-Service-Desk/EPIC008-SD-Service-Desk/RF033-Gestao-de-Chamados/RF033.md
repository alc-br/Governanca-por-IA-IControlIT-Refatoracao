...
- [x] Multi-tenancy (isolamento por conglomerado)
...
| **Tenant** | Conglomerado - unidade lógica de isolamento de dados |
...
- Fila deve existir, estar ativa e pertencer ao mesmo conglomerado
...
- Se informados, devem existir, estar ativos e pertencer ao mesmo conglomerado
...
**Descrição**: Um usuário só pode acessar chamados do seu próprio conglomerado.

**Justificativa**: Garantir segurança e conformidade LGPD.

**Critério de Aceite**:
- Todas as queries filtram por `ConglomeradoId` do usuário logado
