...
**Descrição**: Um usuário só pode acessar e gerenciar SLAs do seu próprio conglomerado (tenant).

**Critério de Aceite**:
- Tentativa de acesso cruzado → rejeição (HTTP 404)
- Filtro Id_Conglomerado aplicado em todas as queries
...
- **Multi-Tenancy Rigoroso**: Filtro global Id_Conglomerado
